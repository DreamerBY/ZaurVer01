...
public class Student {
    ...
    double sredneeArifm(double a1, double b1, double c1) {
        double result2 = (a1 + b1 + c1) / 3;
        System.out.println("!!! Средний бал - " + result2);
        return result2;
    }
}
...
class StudentTest {
    double sredArifmOcenka(Student st) {
        double sredOcenka = (st.economicevaluation + st.mathevaluation + st.languagegradeevaluation) / 3;
        System.out.println(sredOcenka);
        return sredOcenka;
    }
    ...
    public static void main(String[] args) {
        ...
        // s1.sredneeArifm(20.5,30.56,45.45);
        sTEST.sredArifmOcenka(Petrov);
        sTEST.sredArifmOcenka(Ivanov);
        sTEST.sredArifmOcenka(Ivanov);
